...
function setup()
  ...
  local raster_path_impedance = "/data/rasterized_maps/impedance_car_hour_night.asc"
  ...
  return {
    properties = {
      ...
      uma_base_speed_multiplier      = 0.81,
      uma_impedance_multiplier       = 1.0,  -- use 0.0 to turn off impedance map
      uma_traffic_signal_penalty     = 5.2,  -- 2 + 3.52 * 0.92 -> note: used in obstacles_mod
      uma_stop_sign_penalty          = 5.0,  -- heuristic, not informed by model
      uma_intersection_penalty_3     = 1.0,  --  2.06 * 0.50
      uma_intersection_penalty_4     = 4.6,  --  5.70 * 0.81
