...
function setup()
  ...
  local raster_path_impedance = "/data/rasterized_maps/impedance_ebike45_none.asc"
  ...
  return {
    properties = {
      ...
      uma_base_speed_multiplier     = 0.44, -- Subtracted 0.01, see bicycle_uma.lua (0.01 instead of 0.04)
      uma_impedance_multiplier      = 1.0,  -- use 0.0 to turn off impedance map
      uma_intersection_penalty_4    = 0.72,  --  7.24 * 0.10
      uma_elev_penalty_gain         = 1.22,
      uma_elev_penalty_loss         = -0.1,  -- Assumption (should be close to 0)
    },
