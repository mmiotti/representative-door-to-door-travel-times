...
function setup()
  ...
  local raster_path_impedance = "/data/rasterized_maps/impedance_rbike_none.asc"
  ...
  return {
    properties = {
      ...
      u_turn_penalty                = 20,
      traffic_signal_penalty        = 6, -- heuristic, not informed by model (note: right turns should often not incur penalty)
      ...
      uma_base_speed_multiplier     = 0.70, -- Subtracting 0.04 because MOBIS is quite a bit faster (though with some e-bikes), and Google Maps is faster by 0.04 as well
      uma_impedance_multiplier      = 1.0,  -- use 0.0 to turn off impedance map
      uma_intersection_penalty_4    = 0.72,  --  7.24 * 0.10
      uma_elev_penalty_gain         = 3.07,
      uma_elev_penalty_loss         = -0.52,
    },
