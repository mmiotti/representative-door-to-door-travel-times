...
function setup()
  ...
  local raster_path_impedance = "/data/rasterized_maps/impedance_ebike25_none.asc"
  ...
  return {
    properties = {
      ...
      uma_base_speed_multiplier     = 0.65, -- Subtracted 0.02, see bicycle_uma.lua (0.02 instead of 0.04)
      uma_impedance_multiplier      = 1.0,  -- use 0.0 to turn off impedance map
      uma_intersection_penalty_4    = 0.72,  --  7.24 * 0.10
      uma_elev_penalty_gain         = 1.45,
      uma_elev_penalty_loss         = -0.35,  -- Assumption (slightly less than regular bicycle)
    },
