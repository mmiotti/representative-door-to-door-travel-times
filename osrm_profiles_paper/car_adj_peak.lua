...
function setup()
  ...
  local raster_path_impedance = "/data/rasterized_maps/impedance_car_hour_peak.asc"
  ...
  return {
    properties = {
      ...
      uma_base_speed_multiplier      = 0.80,
      uma_impedance_multiplier       = 1.0,  -- use 0.0 to turn off impedance map
      uma_traffic_signal_penalty     = 14.67, -- 2 + 13.77 * 0.92 -> note: used in obstacles_mod
      uma_stop_sign_penalty          = 5.0,  -- heuristic, not informed by model
      uma_intersection_penalty_3     = 1.6,  --  3.24 * 0.50
      uma_intersection_penalty_4     = 5.1,  --  6.34 * 0.81
